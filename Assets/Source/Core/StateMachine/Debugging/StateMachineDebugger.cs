...
namespace Source.Core.StateMachine.Debugging
{
	/// <summary>
	...
	internal class StateMachineDebugger
	{
		...
		private Source.Core.StateMachine.StateMachine _stateMachine;
		...
		/// </summary>
		internal void Awake(Source.Core.StateMachine.StateMachine stateMachine)
		{

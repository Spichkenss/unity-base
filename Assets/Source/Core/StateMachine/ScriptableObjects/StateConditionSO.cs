...
namespace Source.Core.StateMachine.ScriptableObjects
{
	public abstract class StateConditionSO : ScriptableObject
	{
		...
		/// </summary>
		internal StateCondition GetCondition(Source.Core.StateMachine.StateMachine stateMachine, bool expectedResult, Dictionary<ScriptableObject, object> createdInstances)
		{

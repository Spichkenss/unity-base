...
namespace Source.Core.StateMachine.ScriptableObjects
{
	...
	public class StateSO : ScriptableObject
	{
		...
		/// </summary>
		internal State GetState(Source.Core.StateMachine.StateMachine stateMachine, Dictionary<ScriptableObject, object> createdInstances)
		{
		...
		private static StateAction[] GetActions(StateActionSO[] scriptableActions,
			Source.Core.StateMachine.StateMachine stateMachine, Dictionary<ScriptableObject, object> createdInstances)
		{
